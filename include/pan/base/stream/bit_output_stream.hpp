#ifndef __PAN_BIT_OSTREAM_HPP__
#define __PAN_BIT_OSTREAM_HPP__
...
inline static bit::ostream& operator << (bit::ostream& os, const std::string& in)
{
...
inline static bit::ostream& operator << (bit::ostream& os, const char* const& in)
{
    os << std::string(in);
    return os;
}
...
template <typename T>
inline static bit::ostream& operator << (bit::ostream& os, const std::vector<T>& in)
{
    std::uint16_t len = static_cast<std::uint16_t>(in.size());
    os.write(len);
...
template <>
inline static bit::ostream& operator << (bit::ostream& os, const std::vector<char>& in)
{
    std::uint16_t len = static_cast<std::uint16_t>(in.size());
    os.write(len);
    os.write_bytes(in.data(), in.size());
...
template <typename T>
inline static bit::ostream& operator << (bit::ostream& os, const std::list<T>& in)
{
    std::uint16_t len = static_cast<std::uint16_t>(in.size());
    os.write(len);
    for (const T& element : in) {
...
inline static void ostream_write_tuple_impl(bit::ostream& os, const Tuple& tuple, std::index_sequence<Is...>)
{
    std::initializer_list<int>{(os.write(std::get<Is>(tuple)), 0)...};
}

template <typename... Args>
inline static bit::ostream& operator << (bit::ostream& os, std::tuple<Args...>& in)
{
...
template <typename... Args>
inline static void ostream_write_n(bit::ostream& os, Args... args)
{
